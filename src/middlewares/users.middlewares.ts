// te sẽ làm chức năng đăng nhập ./login
      ...
      email: {
        ...
        custom: {
          options: async (value, { req }) => {
            ...
            req.user = user // giữ giùm user req hoihsting tạo ra user
            return true
          }
        }
      },
      ...
      Authorization: {
        ...
        custom: {
          options: async (value, { req }) => {
            ...
            // xuống dc đây thì access_token có rồi
      ...
      email_verify_token: {
        ...
        custom: {
          options: async (value: string, { req }) => {
            ...
            //verify_email_token để lấy decoded_email_verify_token
            try {
